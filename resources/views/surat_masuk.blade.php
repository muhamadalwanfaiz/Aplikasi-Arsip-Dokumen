                    ...
                    @foreach($surat_masuk as $masuk)
                        <tr>
                            ...
                            <td class="text-center">
                                <button type="button" id="btn-edit-jenisDok" class="btn btn-success" data-toggle="modal" data-target="#editJenisDokModal" data-id="{{ $masuk->id }}">Edit</button>
                                <button type="button" id="btn-delete-jenisDok" class="btn btn-danger" onclick="deleteConfirmation('{{$masuk->id}}','{{$masuk->no_surat}}')">Hapus</button>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
